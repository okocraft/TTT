...
public final class Settings {
    ...
    public static final ConfigValue<Boolean> SPAWNER_STOPPED_BY_REDSTONE_SIGNAL =
            config -> config.getBoolean("spawner.stopped-by-redstone-signal");
    public static final ConfigValue<Boolean> SPAWNER_CANCEL_CHANGING_MOB =
            config -> config.getBoolean("spawner.cancel-changing-mob");
    public static final ConfigValue<Integer> SPAWNER_MAX_TOTAL_MOBS =
            config -> config.getInteger("spawner.max-total-mobs");
